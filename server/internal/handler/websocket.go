...
func HandleWebSocket(c *gin.Context, hub *service.WSHub, ledgerService *service.LedgerService) {
	...
	if err := ledgerService.EnsureMember(c.Request.Context(), ledgerID, userID); err != nil {
