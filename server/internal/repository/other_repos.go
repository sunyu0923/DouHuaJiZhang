...
func (r *InvestmentRepository) DeleteByUserID(ctx context.Context, id, userID uuid.UUID) (bool, error) {
...
func (r *HealthRepository) DeletePoopRecordByUserID(ctx context.Context, id, userID uuid.UUID) (bool, error) {
...
func (r *HealthRepository) DeleteMenstrualRecordByUserID(ctx context.Context, id, userID uuid.UUID) (bool, error) {
